drop function if exists app.submit_public_consent(text, text, text, inet, text);
drop function if exists public.submit_public_consent(text, text, text, inet, text);
...
revoke all on function app.submit_public_consent(text, text, text, inet, text, boolean, uuid) from public;
grant execute on function public.submit_public_consent(text, text, text, inet, text, boolean, uuid) to anon, authenticated;
